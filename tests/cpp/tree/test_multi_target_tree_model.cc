...
TEST(MultiTargetTree, JsonIO) {
  ...
  linalg::Vector<float> base_weight{{1.0f, 2.0f, 3.0f}, {3ul}, &ctx};
  linalg::Vector<float> left_weight{{2.0f, 3.0f, 4.0f}, {3ul}, &ctx};
  linalg::Vector<float> right_weight{{3.0f, 4.0f, 5.0f}, {3ul}, &ctx};
