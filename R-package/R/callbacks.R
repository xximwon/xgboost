...
#' colnames(x)
#' dtrain <- xgb.DMatrix(scale(x), label = 1*(iris$Species == "versicolor"), nthread = 1)
...
#' bst <- xgb.train(param, dtrain, list(tr=dtrain), nrounds = 100, eta = 1.,
...
#' bst <- xgb.train(param, dtrain, list(tr=dtrain), nrounds = 100, eta = 0.8,
