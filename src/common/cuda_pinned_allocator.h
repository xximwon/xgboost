...
class managed_allocator {
 public:
  ...
  template <typename U>
  struct rebind {                       // NOLINT
    using other = managed_allocator<U>;  // NOLINT: The rebound type
  };
  ...
  managed_allocator& operator=(managed_allocator const& that) = default;
  managed_allocator& operator=(managed_allocator&& that) = default;
